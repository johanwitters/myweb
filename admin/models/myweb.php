 ...
 * @since  0.0.1
 */
class MyWebModelMyWeb extends JModelAdmin
{
	/**
	 ...
	 * @since   1.6
	 */
	public function getTable($type = 'MyWeb', $prefix = 'MyWebTable', $config = array())
	{
...
/**
	...
	protected function canDelete($record)
	{
		if( !empty( $record->id ) )
		{
			return JFactory::getUser()->authorise( "core.delete", "com_myweb.myweb." . $record->id );
		}
	}
}
